...
const ContactUs = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "1bb09754-b489-4c84-93cb-03ae67b1898a");
      ...
      <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
        ...
        <div>
         ...
         <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
          ...
          <input type="email" type="text" placeholder='Enter your email' className='w-full p-3 text-sm outline-none' required/>
         </div>
        </div>
